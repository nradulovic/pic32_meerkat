...
# Source Files
SOURCEFILES=application/source/epa_btman.c application/source/bsp.c application/source/epa_codec.c application/source/main.c application/source/epa_btdrv.c application/source/support.c application/source/conv.c application/source/epa_radio.c application/source/app_timer.c application/source/epa_notification.c application/source/epa_serial.c application/source/epa_sync.c driver/source/adc.c driver/source/i2c.c driver/source/lld_spis.c driver/source/lld_spi2.c driver/source/clock.c driver/source/gpio.c driver/source/s25fl.c driver/source/lld_spi1.c driver/source/rtc.c driver/source/spi.c driver/source/intr.c driver/source/systick.c driver/source/codec.c driver/source/lld_uart1.c driver/source/uart.c driver/source/lld_uart2.c esolid-base/port/pic32-none-gcc/mips-m4k/cpu.c esolid-base/port/pic32-none-gcc/mips-m4k/intr.c esolid-base/port/pic32-none-gcc/mips-m4k/systimer.c esolid-base/src/debug.c esolid-base/src/base.c esolid-base/src/error.c esolid-base/src/prio_queue.c esolid-eds/src/smp.c esolid-eds/src/event.c esolid-eds/src/epa.c esolid-mem/src/mem_class.c esolid-mem/src/heap.c esolid-mem/src/static.c esolid-mem/src/pool.c esolid-vtimer/src/vtimer.c
...
${OBJECTDIR}/driver/source/lld_uart1.o: driver/source/lld_uart1.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/driver/source/lld_uart1.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -mips16 -mno-float -O1 -D_PLIB_DISABLE_LEGACY -I"driver/include" -I"application/include" -I"esolid-base/inc" -I"esolid-base/port/pic32-none-gcc/common" -I"esolid-base/port/pic32-none-gcc/mips-m4k" -I"esolid-base/port/pic32-none-gcc/pic32mx150f128d" -I"esolid-eds/inc" -I"esolid-mem/inc" -I"esolid-vtimer/inc" -Wall -pedantic -MMD -MF "${OBJECTDIR}/driver/source/lld_uart1.o.d" -o ${OBJECTDIR}/driver/source/lld_uart1.o driver/source/lld_uart1.c    -Wextra
